...
enum {
    ...
    E_TIMEDOUT = 13,     /* Operation timed out */
    /* File system error codes -- only seen in user-level */
    E_NO_DISK = 14,     /* No free space left on disk */
    E_MAX_OPEN = 15,    /* Too many files are open */
    E_NOT_FOUND = 16,   /* File or block not found */
    E_BAD_PATH = 17,    /* Bad path */
    E_FILE_EXISTS = 18, /* File already exists */
    E_NOT_EXEC = 19,    /* File not a valid executable */
    E_NOT_SUPP = 20,    /* Operation not supported */
    MAXERROR
};
